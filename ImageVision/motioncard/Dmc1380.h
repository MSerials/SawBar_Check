...
DMC1000_API BYTE WINAPI d1000_get_axis_status(short axis);

extern DWORD DMC1000_m_nCards; //总卡数
DMC1000_API int WINAPI d1000_check_sn(WORD cardno, char * str_sn);
DMC1000_API long WINAPI d1000_get_password(short cardno);
#ifdef __cplusplus
}
#endif
