...
typedef enum GX_FEATURE_ID
{
	...
	GX_STRING_DEVICE_VERSION          = 3 | GX_FEATURE_STRING,     ///< 设备版本
	GX_STRING_DEVICE_SERIAL_NUMBER    = 4 | GX_FEATURE_STRING,     ///< 序列号
	...
	GX_ENUM_AA_LIGHT_ENVIRMENT        = 6007 | GX_FEATURE_ENUM,   ///< 自动曝光、自动增益，光照环境类型,参考GX_AA_LIGHT_ENVIRMENT_ENTRY
	GX_INT_AAROI_OFFSETX              = 6008 | GX_FEATURE_INT,    ///< 自动曝光、自动增益，感兴趣区域X偏移
	GX_INT_AAROI_OFFSETY              = 6009 | GX_FEATURE_INT,    ///< 自动曝光、自动增益，感兴趣区域Y偏移
	GX_INT_AAROI_WIDTH                = 6010 | GX_FEATURE_INT,    ///< 自动曝光、自动增益，感兴趣区域宽度
	GX_INT_AAROI_HEIGHT               = 6011 | GX_FEATURE_INT,    ///< 自动曝光、自动增益，感兴趣区域高度
	...
	//---------------Deprecated Section-------------------------
	GX_STRING_DEVICE_ID               = 4    | GX_FEATURE_STRING, ///< 序列号[弃用，改用GX_STRING_DEVICE_SERIAL_NUMBER]	
	GX_STRING_DEVICE_HARDWARE_VERSION = 5    | GX_FEATURE_STRING, ///< 硬件版本[弃用]
	GX_INT_GAIN                       = 5002 | GX_FEATURE_INT,    ///< 增益[弃用，改用GX_FLOAT_GAIN]
	GX_INT_BLACKLEVEL                 = 5005 | GX_FEATURE_INT,    ///< 黑电平[弃用，改用GX_FLOAT_BLACKLEVEL]
	GX_FLOAT_BALANCE_RATIO_SELECTOR   = 5007 | GX_FEATURE_ENUM,   ///< 白平衡通道[弃用，改用GX_ENUM_BALANCE_RATIO_SELECTOR]
	GX_INT_ROI_X                      = 6008 | GX_FEATURE_INT,    ///< 自动曝光、自动增益，感兴趣区域X偏移[弃用，改用GX_INT_AAROI_OFFSETX]
	GX_INT_ROI_Y                      = 6009 | GX_FEATURE_INT,    ///< 自动曝光、自动增益，感兴趣区域Y偏移[弃用，改用GX_INT_AAROI_OFFSETY]
	GX_INT_ROI_WIDTH                  = 6010 | GX_FEATURE_INT,    ///< 自动曝光、自动增益，感兴趣区域宽度[弃用，改用GX_INT_AAROI_WIDTH]
	GX_INT_ROI_HEIGHT                 = 6011 | GX_FEATURE_INT,    ///< 自动曝光、自动增益，感兴趣区域高度[弃用，改用GX_INT_AAROI_HEIGHT]
	GX_INT_AUTO_GAIN_VALUEMIN         = 6012 | GX_FEATURE_INT,    ///< 自动增益最小值[弃用，改用GX_FLOAT_AUTO_GAIN_MIN]
	GX_INT_AUTO_GAIN_VALUEMAX         = 6013 | GX_FEATURE_INT,    ///< 自动增益最大值[弃用，改用GX_FLOAT_AUTO_GAIN_MAX]
	GX_INT_AUTO_SHUTTER_VALUEMIN      = 6014 | GX_FEATURE_INT,    ///< 自动曝光最小值[弃用，改用GX_FLOAT_AUTO_EXPOSURE_TIME_MIN]
	GX_INT_AUTO_SHUTTER_VALUEMAX      = 6015 | GX_FEATURE_INT,    ///< 自动曝光最大值[弃用，改用GX_FLOAT_AUTO_EXPOSURE_TIME_MAX]
...
typedef struct GX_FRAME_DATA
{
	...
	int32_t       nImgSize;            ///< 图像大小
	int32_t       reserved[7];         ///< 保留
}GX_FRAME_DATA;
