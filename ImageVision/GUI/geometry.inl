...
inline void CGeom::DoLineToLineIntersect(CPoint &line_seg_begin_A, CPoint &line_seg_end_A, CPoint &line_seg_begin_B, CPoint &line_seg_end_B)
{
...
inline void CGeom::DoLineToReactangleIntersect(CPoint &line_seg_begin, CPoint &line_seg_end, CPoint &rect_begin, CPoint &rect_end)
{
...
inline void CGeom::DoLineToEllipseIntersect(CPoint &line_seg_begin, CPoint &line_seg_end, CPoint &ellipse_rect_begin, CPoint &ellipse_rect_end)
{
...
inline CPoint CGeom::GetIntersectResult()
{
	return res;
}

inline float CGeom::GetIntersectDist(CPoint &from)
{
...
inline CPoint CGeom::Rotate(CPoint &center_pt, float dist_from_center_pt, float theta)
{
...
inline int CGeom::ClipTest(float p, float q, float *u1, float *u2)
{
	float r;
	int retval = TRUE;
...
inline bool CGeom::WithinRectangle(float ptx, float pty, int max_x, int max_y, int min_x, int min_y)
{
